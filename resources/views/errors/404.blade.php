...
<!-- Mirrored from www.pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/html/ltr/vertical-menu-template/error-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Feb 2020 17:48:07 GMT -->
...
<head>
    ...
    <title>Error 404 - Frest - Bootstrap HTML admin template</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('app-assets/css/colors.min.cs')}}s">
                        ...
                        <div class="card bg-transparent shadow-none">
                            <div class="card-content">
                                <div class="card-body text-center">
                                    ...
                                    <p class="pb-3">
                                        we couldn't find the content you are looking for</p>
                                    <img class="img-fluid" src="{{asset('app-assets/images/pages/404.png')}}"
                                        alt="404 error">
                                    <a href="{{URL('/')}}" class="btn btn-primary round glow mt-3">BACK
                                        TO
                                        HOME</a>
                                </div>
                            </div>
