    ...
    <div class="col s12 m12 l12">
        <div id="preselecting" class="card card card-default scrollspy">
            <div class="card-content">
                <div class="card-title">
                    <div class="row">
                        <div class="col s12 m6 l10">
                            <h4 class="card-title">Apertments View</h4>
                        </div>
                        <div class="col s12 m6 l2">
                            <ul class="tabs">
                                <li class="tab col m6 s12 p-0"><a class="p-0 active" href="#main-view-tab">
                                        <i class="material-icons">apps</i></a></li>
                                <li class="tab col m6 s12 p-0"><a class="p-0" href="#html-view-tab"><i
                                            class="material-icons">format_list_bulleted</i></a></li>
                                <li class="indicator" style="left: 0px; right: 180px;"></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col s12">
                        <div class="row active" id="main-view-tab" style="display: block;">
                            GRID tab

                        </div>
                    </div>
                    <div class="col s12">
                        <div id="html-view-tab" style="display: none;" class="">
...
<div style="bottom: 50px; right: 19px;" class="fixed-action-btn direction-top"><a
    ...
    <ul>
        <li><a href="css-helpers.html" class="btn-floating blue"
                style="opacity: 0; transform: scale(0.4) translateY(40px) translateX(0px);"><i
        ...
        <li><a href="app-email.html" class="btn-floating red"
                style="opacity: 0; transform: scale(0.4) translateY(40px) translateX(0px);"><i
