        ...
        <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-light">
            <div class="nav-wrapper">
                ...
                <ul class="dropdown-content" id="profile-dropdown">
                    ...
                    <li><a class="grey-text text-darken-1" href="javascript:void(0);">{{ Auth::user()->name }}</a></li>
                    <li><a class="grey-text text-darken-1" href="user-profile-page.html"><i
                                class="material-icons">person_outline</i>Settings</a></li>
                    ...
                    document.getElementById('logout-form').submit();"><a class="grey-text text-darken-1"
                            href="{{ route('logout') }}"><i class="material-icons">keyboard_tab</i> Logout</a>
                    </li>
