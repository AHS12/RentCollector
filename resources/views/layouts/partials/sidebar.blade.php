        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation"
            ...
            <li class=" nav-item"><a href="javascript:void(0)"><i class="far fa-building"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    ...
                    <li class="@if (Route::getCurrentRoute()->uri() == "apertment/rents"||Route::getCurrentRoute()->uri()=="apertment/rent/details/{id}" ) active
                        @endif"><a href="{{URL('apertment/rents')}}"><i class="fas fa-arrow-right"></i><span
                                class="menu-item" data-i18n="Analytics">Rents</span></a>
                    </li>
                </ul>
            </li>
            <li class=" @if (Route::getCurrentRoute()->uri()== "invoice/details/{id}") active @endif nav-item"><a href="javascript:void(0)"><i class="bx bx-receipt"></i><span class="menu-title"
                        data-i18n="Dashboard">Invoice</span></a>
                <ul class="menu-content">
                    <li class="@if (Route::getCurrentRoute()->uri() == "invoices") active @endif "><a href="{{URL('invoices')}}">
